        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-border bg-white/80 p-4 shadow-sm">
            ...
            <dl className="mt-2 space-y-1 text-sm text-slate-700">
              <div className="flex justify-between"><dt>Started</dt><dd>{session.started_at as string}</dd></div>
              <div className="flex justify-between"><dt>Ended</dt><dd>{session.ended_at as string}</dd></div>
          ...
          <div className="rounded-lg border border-border bg-white/80 p-4 shadow-sm">
            ...
            <dl className="mt-2 space-y-1 text-sm text-slate-700">
              ...
              <div className="flex justify-between"><dt>Cost</dt><dd>${Number(session.cost_usd).toFixed(3)}</dd></div>
